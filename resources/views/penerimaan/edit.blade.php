                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="">
                                ...
                                @endif
                            <!-- form start -->
                            <form action="{{ route('penerimaan.update', $item->id) }}" class="w-full" method="POST"
                    enctype="multipart/form-data">
                                ...
                                <div class="card-body mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $item->tglkembali }}" name="tglkembali" class="form-control"
                                        id="tglkembali" type="date" placeholder="Tanggal">
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input value="{{ $item->total_anggaran }}" name="total_anggaran" type="number" class="form-control" id="total_anggaran" placeholder="total_anggaran">
                                            </div>
                                        <div class="form-group">
