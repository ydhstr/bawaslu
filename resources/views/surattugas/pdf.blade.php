...
<table border="0" align="left">
    ...
    <tr>
        ...
        <td style="text-align: left; width: 50px;">:</td>
        <td>{{ $item->staf->jabatan }}</td> <!-- Tambahkan penutup tag td yang hilang -->
    </tr>
    <tr>
        <td style="text-align: right; width: 400px;">Instansi</td>
        <td style="text-align: left; width: 50px;">:</td>
        <td>{{ $item->staf->instansi }}</td> <!-- Tambahkan penutup tag td yang hilang -->
    </tr>
    {{-- <tr>
        <td>Tanggal Tugas</td>
        <td>:</td>
