...
<div class="col-md-12">
    <div class="card card-primary">
      ...
      <div class="card-body">
        <form method="GET" action="/get-data-ev">
        <div class="row">
            <div class="col-sm-5">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">Laporan Data Evaluasi</h2>
          {{-- <div class="card-tools">
            <div class="input-group input-group-sm" style="width: 150px;">
              <input type="text" name="table_search" class="form-control float-right" placeholder="Search">
...
<div class="row no-print">
  <div class="col-12 mb-3">
    <a href="{{ route('CtkEv', ['dari' => request()->input('dari'), 'sampai' => request()->input('sampai')]) }}" class="btn btn-danger float-right" style="margin-right: 5px;">
